                     ...
                     <form method='post'>
                        ...
                        <div class="ee_mailchimp_api_options">
                           ...
                           <div class="ee_mailchimp_double_opt">
                              ...
                              <p class="ee_mailchimp_tips">
                                 <?php _e("* You can read more about how double opt-in works, <a href='http://kb.mailchimp.com/article/how-does-confirmed-optin-or-double-optin-work/' target='_blank'>here</a>.", 'event_espresso'); ?>
                              </p>
                           </div>
                        </div>
                        <div>
