...
class EED_MailChimp extends EED_Module {
    ...
    public static function set_hooks_admin() {
        ...
        add_action( 'wp_ajax_espresso_mailchimp_upgate_groups', array('EED_MailChimp', 'espresso_mailchimp_upgate_groups') );
        // Ajax for MailChimp list fields refresh
        add_action( 'wp_ajax_espresso_mailchimp_upgate_list_fields', array('EED_MailChimp', 'espresso_mailchimp_upgate_list_fields') );
    }
