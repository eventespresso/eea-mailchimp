 ...
 * ------------------------------------------------------------------------
 */
class EE_MC_Metabox_Template extends EE_Form_Section_Proper {
	 ...
	 */
	function __construct( EE_MCI_Controller $mc_controller, $event_id, $list_id, $category_id ) {
